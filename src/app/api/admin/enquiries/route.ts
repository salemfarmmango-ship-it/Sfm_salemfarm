...
export async function GET(request: NextRequest) {
    try {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/enquiries.php?${searchParams.toString()}`, {
            cache: 'no-store',
            headers: {
...
export async function PATCH(request: NextRequest) {
    try {
        ...
        const res = await fetch('${process.env.NEXT_PUBLIC_API_URL}/enquiries.php', {
            method: 'PUT',
            headers: { 
